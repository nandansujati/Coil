...
- (UIView *)buildMenuItemView
{
    ...
    label.textColor=[UIColor colorWithRed:255.0f/255.0f green:153.0f/255.0f blue:120.0f/255.0f alpha:1.0f];
    
    [label setFont:[UIFont fontWithName:@"SFUIText-Semibold" size:17]];
