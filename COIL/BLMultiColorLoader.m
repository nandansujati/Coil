...
#define DEFAULT_COLOR [UIColor colorWithRed:255.0f/255.0f green:153.0/255.0f blue:120.0f/255.0f alpha:1.0f ]
...
{
    self.lineWidth = 2.0;
    self.colorArray = [NSArray arrayWithObjects:[UIColor redColor],nil];
